...
/**
 * Klasa ktora sluzy do zapisania struktury plikow w podanej path. Kazdy element reprezentuje jedna pozycje w systemie plikow (folder lub plik)
 * @author Mateusz
 *
 */
public class FilesystemElement implements Serializable {
	 ...
	 * @param parent null jezeli ten element ma okresla najwyzszy katalog
	 * @throws IOException
	 */
